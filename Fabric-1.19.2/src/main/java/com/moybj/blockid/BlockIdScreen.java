    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float partialTick) {
        ...
        if (isReplaceMode) {
            ...
            if (targetTabMode) {
                ...
                renderList(matrices, midX, listStartY - scrollFrequent, frequentBlocks, selectedTargets, 0xCCFF9800, 0xAA000000, "frequent");
                RenderSystem.disableScissor();
                renderScrollbar(matrices, midX + colWidth, listStartY, listEndY - listStartY, scrollFrequent, frequentBlocks.size());
            } else {
                scissor(midX - 5, listStartY, midX + colWidth, listEndY + 10);
            ...
            scissor(midX - 5, listStartY, midX + colWidth, listEndY + 10);
            renderList(matrices, midX, listStartY - scrollFrequent, frequentBlocks, selectedIds, 0xCC4CAF50, 0xAA000000, "frequent");
            RenderSystem.disableScissor();
            renderScrollbar(matrices, midX + colWidth, listStartY, listEndY - listStartY, scrollFrequent, frequentBlocks.size());
            ...
            try {
                ...
                if ("selected".equals(listKind)) {
                    ...
                    if ("all".equals(listKind)) {
                        if (isInFrequent(blockId)) this.textRenderer.draw(matrices, "✔", x + colWidth - 16, y + 6, 0xFF00FF00);
